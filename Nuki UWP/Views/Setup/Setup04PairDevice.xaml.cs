...
namespace Nuki.Pages.Setup
{
    ...
    public sealed partial class Setup04PairDevice : Page
    {
        ...
        {
            SetupNewLock.Current.ViewModel.BackgoundMode = BackgoundMode.None;
                ...
                await Dispatcher.RunAsync(CoreDispatcherPriority.Low, async () =>
                 {
                     ...
                     {
                         var pairResult = await blCon.PairDevice(SetupNewLock.Current.ViewModel.MyName);
                         ...
                         switch (status)
                         {
                             case BlutoothPairStatus.Successfull:
                                 ...
                                 progressRing.IsActive = false;
                                 SetupNewLock.Current.ViewModel.PairResult = pairResult;
                                 SetupNewLock.Current.ViewModel.GotoNextPage();
                                 break;
        ...
        {
            SetupNewLock.Current.RootFrame.GoBack();
        }
    }
}
